document.addEventListener("DOMContentLoaded", () => {
    ...
    fetch("/src/assets/json/estructuras.json")
        ...
        .then(datos => {
            ...
            const mostrarComponentes = (estructuras) => {
                ...
                if (estructuras.length === 0) {
                    ...
                    estructuras.forEach(funcionflecha => {
            ...
            if (buscador.value === '') {
                ...
                mostrarComponentes(datos.estructuras);
            }
            ...
            buscador.addEventListener("input", (event) => {
                ...
                // 🔹 Filtro normal
                const componentesFiltrados = datos.estructuras.filter(funcionflecha =>
                    funcionflecha.nombre.toLowerCase().includes(query)
                );

                mostrarComponentes(componentesFiltrados);
            });
        })
